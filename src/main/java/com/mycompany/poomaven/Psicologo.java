...
public class Psicologo extends Herencianutricionista {
    ...
    // Constructor
    public Psicologo(String turnossemana, String tiempotrabajado, String horainicio, String horafin, String cedula, String nombre, String apellido, String correo) {
