...
public class CocineroUI extends JFrame {
    private Connection connection;
    private JTable table;
    private DefaultTableModel model;
    private JTextField filterField;

    public CocineroUI(Connection connection) {
    ...
    private void loadData() {
        ...
        try (PreparedStatement ps = connection.prepareStatement(query);
            ...
            JOptionPane.showMessageDialog(this, "Error al cargar los datos de cocinero.", "Error", JOptionPane.ERROR_MESSAGE);
            e.printStackTrace();
        }
    }
    ...
    private void filterData(ActionEvent e) {
        ...
        model.setRowCount(0); // Limpiar datos previos
        String query = "SELECT * FROM cocinero WHERE cedula LIKE ?";
        ...
        try (PreparedStatement ps = connection.prepareStatement(query)) {
            ...
            JOptionPane.showMessageDialog(this, "Error al cargar los datos filtrados de cocinero.", "Error", JOptionPane.ERROR_MESSAGE);
            ex.printStackTrace();
        }
    }
